    ...
    <div class="bg-white space-y-6">
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="text" name="first_name" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('first_name') }}" required>
        </div>
        @error('first_name')
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="text" name="last_name" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('last_name') }}" required>
        </div>
        @error('last_name')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="email" name="email" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('email') }}" required>
        </div>
        @error('email')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="text" name="mobile_number" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('mobile_number') }}" required>
        </div>
        @error('mobile_number')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <select name="gender" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" required>
            <option value="10" {{ old('gender') == 10 ? 'selected' : '' }}>Male</option>
            <option value="20" {{ old('gender') == 20 ? 'selected' : '' }}>Female</option>
            <option value="30" {{ old('gender') == 30 ? 'selected' : '' }}>Other</option>
          </select>
        </div>
        @error('gender')
          <span class="text-red-500" role="alert">{{ $message }}</span>
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="text" name="staff_id" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('staff_id') }}" required>
        </div>
        @error('staff_id')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        <label class="text-sm text-gray-400">Patient ID</label>
        <div class="w-full inline-flex border">
          <div class="w-1/12 pt-2 bg-gray-100">
            <svg fill="none" class="w-6 text-gray-400 mx-auto" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6l4 2" />
          ...
          <input type="text" name="patient_id" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" value="{{ old('patient_id') }}" required>
        </div>
        @error('patient_id')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="password" name="password" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" required>
        </div>
        @error('password')
          <span class="text-red-500" role="alert">{{ $message }}</span>
        @enderror
      ...
      <div>
        ...
        <div class="w-full inline-flex border">
          ...
          <input type="password" name="password_confirmation" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" required>
        </div>
      </div>
