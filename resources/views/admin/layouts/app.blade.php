                ...
                <header class="flex-shrink-0 border-b">
                    <div class="flex items-center justify-between p-2">
                        ...
                        <div class="flex items-center space-x-3">
                            <span class="p-2 text-xl font-semibold tracking-wider uppercase lg:hidden">MHH
                                Dashboard</span>
                            ...
                            <div class="relative" x-data="{ isOpen: false }">
                                ...
                                <div @click.away="isOpen = false" x-show.transition.opacity="isOpen"
                                    ...
                                    <div class="flex flex-col p-4 space-y-1 font-medium border-b">
                                        <span class="text-gray-800">{{ Auth::user()->last_name }}
                                            {{ Auth::user()->first_name }}</span>
                                        <span class="text-sm text-gray-400">{{ Auth::user()->email }}</span>
                                    </div>
                                    <div
                                        class="flex items-center justify-center hover:bg-gray-100 text-red-600 p-2 border-t">
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button class="px-2 py-1 transition rounded-md"
