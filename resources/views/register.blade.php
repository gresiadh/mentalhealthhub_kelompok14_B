                ...
                <div class="col-lg-5 mt-5 border border-2 justify-content-lg-end align-items-center px-lg-5">
                    ...
                    <div>
                        <div class="form-group my-3 py-2">
                            <input type="text" class="form-control form-control-input" id="exampleFormControlInput3"
                        ...
                        <div class="form-group my-3 py-2">
                            <input type="password" class="form-control form-control-input" id="exampleFormControlInput3"
                    ...
                    <div class="my-4">
                        <button
                            class="btn mx-auto d-flex justify-content-center form-control-submit-button">Register</button>
                    </div>
                    <div class="d-flex justify-content-center">
                        <p class="para-light my-4">Already have an account? <span><a class="form-link" href="login.html">
                                    Log in</a></span></p> <br />
