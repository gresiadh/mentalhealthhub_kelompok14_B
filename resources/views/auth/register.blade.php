            ...
            <div class="row d-flex justify-content-center my-5">
                <div class="col-lg-5 mt-5 border border-2 justify-content-lg-end align-items-center px-lg-5">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <div class="form-group mb-1 py-2">
                                <input id="first_name" type="text"
                                    class="form-control form-control-input @error('first_name') is-invalid @enderror"
                        ...
                        <div class="row mb-3">
                            <div class="form-group my-1 py-2">
                                <input id="last_name" type="text"
                                    class="form-control form-control-input @error('last_name') is-invalid @enderror"
                        ...
                        <div class="row mb-3">
                            <div class="form-group my-1 py-2">
                                <input id="email" type="email"
                                    class="form-control form-control-input @error('email') is-invalid @enderror"
                        ...
                        <div class="row mb-3">
                            <div class="form-group my-1 py-2">
                                <input id="password" type="password"
                                    class="form-control form-control-input @error('password') is-invalid @enderror"
                        ...
                        <div class="row mb-3">
                            <div class="form-group my-1 py-2">
                                <input id="password-confirm" type="password" class="form-control form-control-input"
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="d-flex justify-content-center">
                                <p class="para-light my-4">Already have an account? <span><a class="form-link"
                                            href="{{ url('/login') }}"> Log in</a></span></p>
