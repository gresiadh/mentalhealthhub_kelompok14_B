            ...
            <div class="row d-flex justify-content-center my-5">
                <div class="col-lg-5 my-5 border border-2 justify-content-lg-end align-items-center px-lg-5">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-3">
                            <div class="form-group my-1 py-2">
                                <input id="email" type="email"
                                    ...
                                    placeholder="Enter Email to get password reset link" required autocomplete="email"
                                    autofocus>
                        ...
                        <div class="my-4">
                            <button type="submit"
                                class="btn mx-auto d-flex justify-content-center form-control-submit-button">
                                {{ __('Reset Password') }}
                            </button>
                        </div>
                    </form>
