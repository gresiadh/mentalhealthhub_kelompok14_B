            ...
            <div class="row mt-5">
                <div class="d-flex justify-content-end">
                    @if (Auth::user()->type == UserType::USER)
                        <a class="btn-reverse text-center mb-3" href="{{ url('/chat') }}">Chat with a Counsellor
                            @if ($unreadMsg != 0)
                                <span class="badge pulse">{{ $unreadMsg }}</span>
                            @endif
                        </a>
                    @else
                        <a class="btn-reverse text-center mb-3" href="{{ url('/chat') }}">View Chats
                            @if ($unreadMsg != 0)
                                <span class="badge pulse">{{ $unreadMsg }}</span>
                            @endif
                        </a>
                        ...
                        <div class="card-body">
                            <div class="tab-content p-3  bg-white" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <p>Welcome to MHH, select the "Chat with counsellor" button <span><i
                                                class="ml-2 fa-solid fa-arrow-turn-up"></i></span> to begin your counselling
                                        sessions with your preferred therapist. </p>
                                </div>
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                    aria-labelledby="v-pills-profile-tab">
                                    <h3>User Profile</h3>
                                    <form class="form-horizontal mt-3"
                                        action="{{ url('/user/update/' . Auth::user()->id) }}" method="POST"
                                        ...
                                        <div class="row my-4">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div
                                                    class="input-group {{ $errors->has('mobile_number') ? 'has-error' : '' }}">
                                                    <input type="text" name="mobile_number"
                                                        class="form-control form-control" id="mobile_number"
                                            ...
                                            <div class="py-5 d-flex justify-items-center">
                                                <button class="btn-inverse" id="v-pills-profile-tab"
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel"
                                    ...
                                    <form class="form-horizontal mt-3"
                                        action="{{ url('/user/update-password/' . Auth::user()->id) }}" method="POST"
                                        enctype="multipart/form-data" id="parsleyUpdateForm">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="form-group">
                                                <label for="old_password" class="required">Current Password</label>
                                                <div
                                                    class="input-group {{ $errors->has('old_password') ? 'has-error' : '' }}">
                                                    <input type="text" name="old_password"
                                                        class="form-control form-control" id="old_password"
                                                        placeholder="Current Password" required data-parsley-validate-name
                                                        autocomplete="{dydx}">
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    class="input-group {{ $errors->has('new_password') ? 'has-error' : '' }}">
                                                    <input type="text" name="new_password"
                                                        class="form-control form-control" id="new_password"
                                                        placeholder="New Password" data-parsley-validate-name
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    class="input-group {{ $errors->has('confirm_password') ? 'has-error' : '' }}">
                                                    <input type="text" name="confirm_password"
                                                        class="form-control form-control" id="confirm_password"
                                                        placeholder="New Password" data-parsley-validate-name
                                                        autocomplete="off" required>
                                                </div>
                                        ...
                                        <div class="py-4 d-flex justify-items-center">
                                            <button class="btn-inverse" id="v-pills-profile-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="v-pills-profile" aria-selected="false">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
